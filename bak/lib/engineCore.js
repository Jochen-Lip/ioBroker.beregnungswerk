...
module.exports = function runEngine(g) {
    ...
    const {
        ...
        KONFIG_DAUER_DEFAULT, KONFIG_WIEDERHOLUNGEN_DEFAULT, FARBE, TANK_WERT_AKTUEL_BESCHREIBUNG,
        ...
        on, unsubscribe, schedule, log, getState, setState, existsState, getObject, existsObject,
